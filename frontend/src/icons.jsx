...
export function IconPlus(props) { return (<svg {...base} {...props}><path d="M12 5v14M5 12h14" /></svg>) }
export function IconWarning(props) { return (<svg {...base} {...props}><path d="M12 3.5 21.5 20h-19L12 3.5Z" /><path d="M12 9.5v4.2" /><circle cx="12" cy="16.7" r="0.15" fill="currentColor" stroke="none" /></svg>) }
export function IconWifiOff(props) { return (<svg {...base} {...props}><path d="M2.5 2.5l19 19" /><path d="M5 8.8a15 15 0 0 1 4.4-2.6M18.9 8.7a15 15 0 0 1 1.6 1.2M8.3 12.6a9 9 0 0 1 4.9-1.5c1 0 1.9.15 2.8.45M12 16.5a4.5 4.5 0 0 1 2.3.65" /><circle cx="12" cy="20" r="0.15" fill="currentColor" stroke="none" /></svg>) }
export function IconCheckCircle(props) { return (<svg {...base} {...props}><circle cx="12" cy="12" r="9" /><path d="M8 12.3l2.6 2.6L16.3 9" /></svg>) }
export function IconMapPin(props) { return (<svg {...base} {...props}><path d="M12 21.5S5 14.8 5 9.8a7 7 0 1 1 14 0c0 5-7 11.7-7 11.7Z" /><circle cx="12" cy="9.8" r="2.3" /></svg>) }
...
export function IconMenu(props) { return (<svg {...base} {...props}><path d="M4 6.5h16M4 12h16M4 17.5h16" /></svg>) }
export function IconGlobe(props) { return (<svg {...base} {...props}><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3c2.5 2.4 3.8 5.6 3.8 9s-1.3 6.6-3.8 9c-2.5-2.4-3.8-5.6-3.8-9S9.5 5.4 12 3Z" /></svg>) }
export function IconAlgeriaFlag({ width = 22, height = 22, ...props }) { return (<svg width={width} height={height} viewBox="0 0 30 20" {...props}><rect x="0" y="0" width="15" height="20" fill="#006233" /><rect x="15" y="0" width="15" height="20" fill="#ffffff" /><path fillRule="evenodd" fill="#D21034" d="M 12,10 m -5,0 a 5,5 0 1,0 10,0 a 5,5 0 1,0 -10,0 M 13.5,10 m -4,0 a 4,4 0 1,1 8,0 a 4,4 0 1,1 -8,0" /><path fill="#D21034" d="M14.8,10 l0.55,-1.7 0.55,1.7 1.8,0 -1.45,1.05 0.55,1.7 -1.45,-1.05 -1.45,1.05 0.55,-1.7 -1.45,-1.05 Z" /></svg>) }
export function IconGlobeColor({ width = 22, height = 22, ...props }) { return (<svg width={width} height={height} viewBox="0 0 24 24" {...props}><circle cx="12" cy="12" r="10" fill="#3b82c4" /><path fill="#4caf6d" d="M4 9c1-2 3-3 5-2s2 3 1 4-3 0-4 1-3 0-2-3z" /><path fill="#4caf6d" d="M14 4c2 0 3 2 2 3s-3 0-4-1 0-2 2-2z" /><path fill="#4caf6d" d="M15 14c2-1 4 0 4 2s-2 3-4 3-3-1-3-2 1-2 3-3z" /><path fill="#4caf6d" d="M6 15c1-1 3-1 3 1s-1 3-3 2-1-2 0-3z" /><ellipse cx="12" cy="12" rx="10" ry="4" fill="none" stroke="#ffffff" strokeWidth="0.6" opacity="0.5" /><ellipse cx="12" cy="12" rx="4" ry="10" fill="none" stroke="#ffffff" strokeWidth="0.6" opacity="0.5" /></svg>) }
export function IconTruck(props) { return (<svg {...base} {...props}><path d="M2.5 7.5h11v8h-11Z" /><path d="M13.5 11h4l3 2.8v1.7h-7Z" /><circle cx="7" cy="18" r="1.7" /><circle cx="17" cy="18" r="1.7" /><path d="M2.5 16h2.8M15.5 16h.2M18.7 16H21" /></svg>) }
