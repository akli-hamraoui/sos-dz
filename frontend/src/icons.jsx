  ...
  return (
    <svg width={width} height={height} viewBox="0 0 30 20" {...props}>
      ...
      <path
        fillRule="evenodd"
        fill="#D21034"
        d="M 12,10 m -5,0 a 5,5 0 1,0 10,0 a 5,5 0 1,0 -10,0
           M 13.5,10 m -4,0 a 4,4 0 1,1 8,0 a 4,4 0 1,1 -8,0"
      />
      <path
        fill="#D21034"
        d="M14.8,10 l0.55,-1.7 0.55,1.7 1.8,0 -1.45,1.05 0.55,1.7 -1.45,-1.05 -1.45,1.05 0.55,-1.7 -1.45,-1.05 Z"
      />
    </svg>
  )
}
